  ...
  return (
    <div style={{ 
      ...
      <div style={{
        ...
        aspectRatio: "1",
        borderRadius: "50%",
        border: `${s(isSmall ? 2 : 4)}px solid ${isSpeaking ? data.color : isOffline ? "rgba(255,255,255,0.05)" : "rgba(255,255,255,0.1)"}`,
      ...
      <div style={{ 
        ...
        {!isSmall && (
          <div style={{ color: isOffline ? "#666" : data.color, fontSize: s(16), marginTop: s(5) }}>
